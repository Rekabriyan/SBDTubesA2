...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <hr class="sidebar-divider my-0">
        <li class="nav-item">
            <a class="nav-link" href="<?= BASEURL; ?>/pendaftar/biodata">
                <i class="fas fa-child"></i>
                <span>Biodata Siswa</span></a>
        </li>
        <hr class="sidebar-divider my-0">
        <li class="nav-item">
            <a class="nav-link" href="<?= BASEURL; ?>/pendaftar/formulir">
                <i class="fas fa-clipboard-list"></i>
                <span>Formulir</span></a>
        </li>
        <hr class="sidebar-divider my-0">
        <li class="nav-item">
            <a class="nav-link" href="<?= BASEURL; ?>/pendaftar/berkas">
                <i class="fas fa-folder-open"></i>
                <span>Berkas</span></a>
        </li>
        <hr class="sidebar-divider my-0">
        <li class="nav-item">
            <a class="nav-link" href="<?= BASEURL; ?>/pendaftar/berita">
